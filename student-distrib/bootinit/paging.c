...
static void add_page_dir_entry(void* phys_addr, void* virtual_addr,
                               uint32_t flags);
static void add_page_table_entry(void* phys_addr, void* virt_addr,
                                 uint32_t flags);
 ...
 */
static void add_page_dir_entry(void* phys_addr, void* virt_addr,
                               uint32_t flags) {
...
int paging_tester() {
  ...
  if (page_directory.page_directory_entries[0] !=
          (((int)(&page_table_1)) | dir_ent_0_flags) &&
      page_directory.page_directory_entries[0] !=
          (((int)(&page_table_1)) | dir_ent_0_flags | 0x60) &&
      page_directory.page_directory_entries[0] !=
          (((int)(&page_table_1)) | dir_ent_0_flags | 0x40) &&
      page_directory.page_directory_entries[0] !=
          (((int)(&page_table_1)) | dir_ent_0_flags | 0x20)) {
    result++;
  }

  if (page_directory.page_directory_entries[1] !=
          (int)(KERNEL_ADDR | dir_ent_1_flags) &&
      page_directory.page_directory_entries[1] !=
          (int)(KERNEL_ADDR | dir_ent_1_flags | 0x60) &&
      page_directory.page_directory_entries[1] !=
          (int)(KERNEL_ADDR | dir_ent_1_flags | 0x40) &&
      page_directory.page_directory_entries[1] !=
          (int)(KERNEL_ADDR | dir_ent_1_flags | 0x20)) {
    result++;
  }

  if (page_table_1.page_table_entries[PT_IDX(VIDEO_ADDR)] !=
          (int)(VIDEO_ADDR | tab_ent_vid_flags) &&
      page_table_1.page_table_entries[PT_IDX(VIDEO_ADDR)] !=
          (int)(VIDEO_ADDR | tab_ent_vid_flags | 0x60) &&
      page_table_1.page_table_entries[PT_IDX(VIDEO_ADDR)] !=
          (int)(VIDEO_ADDR | tab_ent_vid_flags | 0x40) &&
      page_table_1.page_table_entries[PT_IDX(VIDEO_ADDR)] !=
          (int)(VIDEO_ADDR | tab_ent_vid_flags | 0x20)) {
    result++;
  }
